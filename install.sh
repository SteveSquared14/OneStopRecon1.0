...
echo -e "\n"
        ...
        echo -e " -g  | --grabbing banner \t\tGain deatils about a system on a network \t\t\t| Takes a domain as an argument\t\t\t\t[Passive]"
	echo -e " -M  | --MetaDataExtractor\t\tExracts data from files \t\t\t\t\t| File(s) to be analysed to be passed as parameters\t[Passive]"
        ...
        echo -e " -n  | --Name Server Enumeration \tLocating all DNS servers and records for a company \t\t| Takes a domain as an argument\t\t\t\t[Passive/Active]"
